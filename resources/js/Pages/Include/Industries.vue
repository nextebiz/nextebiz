<template>
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 fill-white dark:fill-gray-200  font-bold">
...
.icon-industry {
    @apply w-[60px] mr-2 bg-gray-700 p-3 border border-gray-200 dark:border-gray-600 rounded-md;
}
</style>
