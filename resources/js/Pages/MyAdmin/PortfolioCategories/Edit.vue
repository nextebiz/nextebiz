...
const form = useForm({
    title: props.portfoliocategory.title,
    enabled: props.portfoliocategory.enabled == 1 ? true : false,
});


function submitCategory() {
    const posturl = '/myadmin/portfoliocategories/' + props.portfoliocategory.id;
    form.patch(posturl, { preserveScroll: true });
}
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <MenuButton title="Edit Portfolio Category" />
        <div class="pb-10">
