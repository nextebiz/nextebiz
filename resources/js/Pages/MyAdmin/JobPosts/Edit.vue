...
const form = useForm({
    ...
    candidates_required: props.jobpost.candidates_required,
});

function submitCategory() {
    form.put(route('myadmin.jobposts.update', props.jobpost));
}
...
{{ form.featured }}
                            ...
                            <div class="mb-5">
                                <label for="cities" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cities <span class="font-italic text-xs text-green-500">- To create a post for multiple cities,
                                        provide a comma-separated list.</span></label>
                            ...
                            <div class="mb-5">
                                ...
                                <!-- <textarea v-model="form.description"
                                    class="mb-5 h-40 w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></textarea> -->
