<template>
    ...
    <div id="drawer-navigation" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-64 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
        ...
        <div class="relative">
            <div id="drawer-navigation-label" class="pt-4 text-xs font-semibold text-gray-500 uppercase dark:text-gray-400 ">Candidate Menu</div>
            ...
            <div class="py-5 overflow-y-auto">
                ...
                <ul class="space-y-2 font-medium">
                    <li>
                        <Link @click="addBodyScroll" href="/candidate" data-drawer-hide="drawer-navigation"
                    ...
                    <li>
                        <Link @click="addBodyScroll" href="/candidate/profile" data-drawer-hide="drawer-navigation"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <Link @click="addBodyScroll" :href="route('profile.password')" data-drawer-hide="drawer-navigation"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <Link @click="addBodyScroll" :href="route('profile.deleteaccount')" data-drawer-hide="drawer-navigation"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor"
                            class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">
                            <path
                    ...
                    <li>
                        <Link @click="addBodyScroll" :href="route('logout')" method="post" as="button"  data-drawer-hide="drawer-navigation"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
