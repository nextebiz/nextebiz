<template>
    ...
    <footer class="bg-gray-200 dark:bg-gray-900 dark:text-white">
                ...
                <div class="grid grid-cols-3 gap-2 sm:gap-12 sm:grid-cols-3">
                    <!-- <div>
                        ...
                        <ul class="text-gray-500 dark:text-gray-400 font-medium">
                            ...
                            <li class="mb-4">
                                <a href="#" class="hover:underline">Laravel / React</a>
                            </li>
                            <li class="mb-4">
                                <a href="#" class="hover:underline">MERN Stack</a>
                            </li>
                            <li class="mb-4">
                                <a href="#" class="hover:underline">MEAN Stack</a>
                            </li>
                        </ul>
                    </div> -->
                    <div>
