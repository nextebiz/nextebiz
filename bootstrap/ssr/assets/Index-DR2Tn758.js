import { onMounted, onUnmounted, withCtx, createVNode, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="container m-auto"${_scopeId}><h1${_scopeId}>Aboutx</h1></div>`);
          } else {
            return [
              createVNode("div", { class: "container m-auto" }, [
                createVNode("h1", null, "Aboutx")
              ])
            ];
          }
        }),
