...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(
      `./Pages/${name}.vue`,
      /* @__PURE__ */ Object.assign({ "./Pages/About/Index.vue": () => import("./assets/Index-DR2Tn758.js"), "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-BjwOEphs.js"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-BKU_FbwP.js"), "./Pages/Auth/Login.vue": () => import("./assets/Login-hHDCsviG.js"), "./Pages/Auth/Register.vue": () => import("./assets/Register-oilrlLtt.js"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword-CXYecdqA.js"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-kBCqkwk9.js"), "./Pages/Career/Index.vue": () => import("./assets/Index-Cgo0-AEs.js"), "./Pages/Contact/Index.vue": () => import("./assets/Index-COz5_1dV.js"), "./Pages/Dashboard.vue": () => import("./assets/Dashboard-IUHUrdG0.js"), "./Pages/Engage/Index.vue": () => import("./assets/Index-CmxWtNr7.js"), "./Pages/Expertise/Index.vue": () => import("./assets/Index-BgMt-tcd.js"), "./Pages/Home.vue": () => import("./assets/Home-BovjJybr.js"), "./Pages/Portfolio/Index.vue": () => import("./assets/Index-CvCnf5qR.js"), "./Pages/Profile/Edit.vue": () => import("./assets/Edit-ClOtpnEY.js"), "./Pages/Profile/Partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm-DFRCl3Sh.js"), "./Pages/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm-CYYEVMV-.js"), "./Pages/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm-BwLAAesb.js"), "./Pages/TraineePrograms/Index.vue": () => import("./assets/Index-9XJmJJ4j.js") })
    ),
    setup({ el, App, props, plugin }) {
      return createSSRApp({ render: () => h$1(App, props) }).use(plugin).use(k).use(CKEditor).use(createPinia()).mount(el);
    },
    progress: {
      color: "#4B5563"
    }
